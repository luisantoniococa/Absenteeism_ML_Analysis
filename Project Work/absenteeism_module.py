...
# create the special class that we will use to predict the new data
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # to preserve the code writen in the preprocesing and ML Log regression, we will add a column with 'NaN' strings
            ...
            # this is a checkpoint called 'preprocessed data'
            self.preprocessed_data = df.copy()
            
            # we will use this line for the next functions
